...
<head>
 ...
 ================================================== -->
    ...
    <!-- CSS
 ================================================== -->
    <link rel="stylesheet" href="<?= base_url('config/assets/') ?>landing/css/bootstrap.min.css" />
    <link rel="stylesheet" href="<?= base_url('config/assets/') ?>landing/css/font-awesome.min.css" />
    <link rel="stylesheet" href="<?= base_url('config/assets/') ?>landing/css/style.css" />
    <link rel="stylesheet" href="<?= base_url('config/assets/') ?>landing/css/colors/color.css" />
    <link rel="stylesheet" href="<?= base_url('config/assets/') ?>landing/css/ionicons.min.css" />
    <link rel="stylesheet" href="<?= base_url('config/assets/') ?>landing/css/owl.carousel.css" />
    <link rel="stylesheet" href="<?= base_url('config/assets/') ?>landing/css/owl.transitions.css" />
...
<body class="royal_preloader">
    ...
    <nav id="menu-wrap" class="menu-back cbp-af-header">
        <div class="menu">
            ...
            <ul>
                ...
                <li>
                    <a class="shadow-hover" href="auth/login.php">Login</span></a>
                </li>
            </ul>
        </div>
    </nav>
    ...
    <main>
        ...
        <div class="section full-height mob-height">
            <div class="background-parallax"
                style="background-image: url('<?= base_url('config/assets/') ?>landing/img/full-2.jpg')"
            ...
            <div class="container">
                <div class="row">
                    <div class="col text-center">
                        <div class="team-wrap">
                            <img src="<?= base_url('config/assets/') ?>landing/img/team2.jpg" alt="">
                            <p>Ketua</p>
                    ...
                    <div class="col mt-4 m-xl-0 text-center">
                        <div class="team-wrap">
                            <img src="<?= base_url('config/assets/') ?>landing/img/team4.jpg" alt="">
                            <p>Web Development</p>
                            <h6>Andrian</h6>
                            <div class="social-team">
                                <ul class="list-social-team">
                    ...
                    <div class="col mt-4 m-md-0 text-center">
                        <div class="team-wrap">
                            <img src="<?= base_url('config/assets/') ?>landing/img/team3.jpg" alt="">
                            <p>Design process</p>
        ...
        <div class="section footer padding-top-big background-image-cover"
            style="background-image: url(<?= base_url('config/assets/') ?>landing/img/footer.jpg);">
            <div class="container">
                <div class="row">
                    <div class="col-md-12">
                        <img src="<?= base_url('config/assets/') ?>landing/img/logo-light.png" alt="logo image" />
                    </div>
    ...
    <!-- JAVASCRIPT
    ================================================== -->
    <script src="<?= base_url('config/assets/') ?>landing/js/jquery.js"></script>
    <script src="<?= base_url('config/assets/') ?>landing/js/royal_preloader.min.js"></script>
    <script src="<?= base_url('config/assets/') ?>landing/js/popper.min.js"></script>
    <script src="<?= base_url('config/assets/') ?>landing/js/bootstrap.min.js"></script>
    <script src="<?= base_url('config/assets/') ?>landing/js/plugins.js"></script>
    <script src="<?= base_url('config/assets/') ?>landing/js/custom.js"></script>
    <script>
        // Type text
